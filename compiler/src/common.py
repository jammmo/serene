...
class Symbol(enum.Enum):
    ...
    collection_literal = enum.auto()
    type_solidifier = enum.auto()
    ...
    extension = enum.auto()
    definitions_extension = enum.auto()
    policies_extension = enum.auto()
    method_definitions = enum.auto()
    include_statement = enum.auto()
    file_name = enum.auto()
    function = enum.auto()
    method_definition = enum.auto()
    ...
    type_parameters = enum.auto()
    def_type_parameters = enum.auto()
